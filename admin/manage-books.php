    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <div class="panel panel-default" style="box-shadow: 0px 12px 24px rgba(2,30,84,.1);">
...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100" style="box-shadow: 0px 12px 24px rgba(2,30,84,.1);">
